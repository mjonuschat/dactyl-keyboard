...
from dactyl_manuform.components.controller_mounts.usb_teensy import (
    TeensyControllerMountModel,
)

from dactyl_manuform.types import Shape


class RJ9TeensyControllerMountModel(TeensyControllerMountModel, RJ9HolderMixin):
